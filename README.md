...
2.-On this line: " model = whisper.load_model("turbo", device=device) " -> you may want to change the model, wich on this case is turbo, to the one that fits your hardware, there are various models that can be consulted on the first link here. 
